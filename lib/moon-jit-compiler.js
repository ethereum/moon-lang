...
var pris = [["if", 3, "(a,b,c)=>$N(a)?(a?b():c()):$P(['if',a,b(),c()])", function (a, b, c) {
...
}], ["get", 2, "(a,k)=>$O(a)&&$S(k)?(($V=a[k])!==$U?$V:null):$P(['get',a,k])", function (a, k, d) {
  return "(($V=" + a + "[" + k + "])!==$U?$V:" + d + ")";
  ...
  return "(" + a + ".length)";
}], ["and", 2, "(a,b)=>$N(a)&&$N(b)?a&b:$P(['and',a,b])", function (a, b) {
  return "(" + a + "&" + b + ")";
}], ["or", 2, "(a,b)=>$N(a)&&$N(b)?a|b:$P(['or',a,b])", function (a, b) {
  return "(" + a + "|" + b + ")";
}], ["xor", 2, "(a,b)=>$N(a)&&$N(b)?a^b:$P(['or',a,b])", function (a, b) {
  return "(" + a + "^" + b + ")";
}]];
