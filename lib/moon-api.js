...
module.exports = function (ipfsUrl) {
  ...
  var stringify = function stringify(value) {
    var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    return synt.termToString(comp.termDecompileFull(value), opts.indent === undefined ? 2 : opts.indent, opts.maxCols || 80);
  };
  ...
  var format = function format(code) {
    var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    return synt.termToString(synt.termFromString(code), opts.indent === undefined ? 2 : opts.indent, opts.maxCols || 80);
  };
